...
[Materialize](https://materialize.com/) is a reactive database that delivers incremental view updates. Materialize facilitates developers an easy build with streaming data using standard SQL.
